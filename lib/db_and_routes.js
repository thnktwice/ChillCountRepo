...
var admins =["m.coenca@gmail.com", "David Baruchel Dominati"];
...
User.extend({
  isAdmin: function() {
  var res = (_.contains(admins,this.emails[0].address));
  return res;      
  },
  uname: function() {
    ...
    var username = this.emails[0].address.split("@",1)[0];
    return username;
  },
